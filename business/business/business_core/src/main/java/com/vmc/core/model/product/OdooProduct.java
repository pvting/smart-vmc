 ...
 * <b>Description:</b> <br>
 */
public class OdooProduct extends Model implements Cloneable {
    /**
     * 商品ID
     */
    public int id;
    ...
    protected OdooProduct(Parcel in) {
        super(in);
        this.id = in.readInt();
    ...
    public static final Creator<OdooProduct> CREATOR = new Creator<OdooProduct>() {
        @Override
        public OdooProduct createFromParcel(Parcel source) {return new OdooProduct(source);}

        @Override
        public OdooProduct[] newArray(int size) {return new OdooProduct[size];}
    };
}
