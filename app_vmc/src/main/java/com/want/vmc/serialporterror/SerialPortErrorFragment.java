...
import com.want.vmc.databinding.VendorHomeSerialporterrorLandLayoutBinding;
...
public class SerialPortErrorFragment extends MFragment implements SerialPortErrorContract.View {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return VendorHomeSerialporterrorLandLayoutBinding.inflate(inflater, container, false).getRoot();
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
         VendorHomeSerialporterrorLandLayoutBinding       binding = DataBindingUtil.getBinding(view);
        SerialPortErrorViewModel model = new SerialPortErrorViewModel();
